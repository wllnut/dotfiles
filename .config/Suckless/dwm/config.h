...
static const char *fonts[]          = { "0xProto Nerd Font Mono:size=12:style=Bold", "monospace:size=16" };
static const char dmenufont[]       = "0xProto Nerd Font Mono:size=16:style=Bold";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Return,             spawn,          {.v = dmenucmd } },                                // open app launcher MOD+return
	{ MODKEY|ShiftMask,             XK_Return,             spawn,          {.v = termcmd } },                                 // spawn terminal MOD+shift+return
	{ MODKEY,	                      XK_b,                  spawn,          SHCMD("firefox") },                                // open browser(firefox) MOD+b
	{ MODKEY|ShiftMask,             XK_s,                  spawn,          SHCMD("flameshot gui") },                          // screenshot MOD+Print
	{ MODKEY,                       XK_e,                  spawn,          SHCMD("exec thunar") },                            // open file manager (thunar) MOD+e
	{ MODKEY,      			            XK_l,                  spawn,          SHCMD("exec slock") },                             // lockscreen MOD+l
	{ MODKEY,                       XK_Down,               focusstack,     {.i = +1 } },                                      // focus window up stack MOD+down
	{ MODKEY,                       XK_Up,                 focusstack,     {.i = -1 } },                                      // focus window down stack MOD+up
	{ MODKEY|ShiftMask,             XK_Down,               movestack,      {.i = +1 } },                                      // move window up stack MOD+down
	{ MODKEY|ShiftMask,             XK_Up,                 movestack,      {.i = -1 } },                                      // move window down stack MOD+up
	...
	{ MODKEY,                       XK_comma,                  setmfact,       {.f = -0.05} },                                    // adjust mfact MOD+h
	{ MODKEY,                       XK_period,                  setmfact,       {.f = +0.05} },                                    // adjust mfact MOD+l
  ...
  { MODKEY,                       XK_space,              togglefloating, {0} },                                             // toggle floating MOD+Space
  ...
  { MODKEY|ALTKEY,                XK_3,                  setlayout,      {.v = &layouts[1]} },                              // change layout to monocle MOD+ALT+3
	...
	{ MODKEY,                       XK_Left,               focusmon,       {.i = -1 } },                                      // move window to monitor MOD+,
	{ MODKEY,                       XK_Right,              focusmon,       {.i = +1 } },                                      // move window to monitor MOD+.
	{ MODKEY|ShiftMask,             XK_Left,               tagmon,         {.i = -1 } },                                      // move window to monitor MOD+SHIFT+,
	{ MODKEY|ShiftMask,             XK_Right,              tagmon,         {.i = +1 } },                                      // move window to monitor MOD+SHIFT+.
